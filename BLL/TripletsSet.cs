...
namespace BLL
{
    ...
    {
        private readonly DAL.TripletsSet dal = new DAL.TripletsSet();

        #region 01.根据ID获得实体对象 +MODEL.TripletsSet GetModel(int intId)
        /// <summary>
        /// 根据ID获得实体对象
        /// </summary>
        ...
        public bool Update(MODEL.TripletsSet model)
        {
        ...
        {
            return dal.getPageList(PageNo, PageSize);
        }
    }
}
